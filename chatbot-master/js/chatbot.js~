        ...
        Engines: {
            ...
            webknox: function (apiKey) {
                ...
                var capabilities = [
                    ...
                    "Ask for distances as in 'how far is Ruwa from Harare town' or 'distance between [place1] and [place2]'.",
                    "Want to know what the weather is like, just ask like 'weather in Harare, Bulawayo'.",
                    "Let Nyasha tell you a joke, just say 'tell me a joke'.",
                    ...
                    "Ask for quotes from a person 'quotes by [person]' or 'quotes by Albert Einstein'.",
                    ...
                    "Or just ask anything that comes to mind like 'Who is Nelson chamisa'.",
                ];
        ...
        thinking: function (on) {
            ...
            if (on) {
                if (!sampleConversationRunning) {
                    $(inputs).attr('enabled', 'enabled');
                }
                ti.html(thinkingHtml);
                lost.html('oops!! looks like Nyasha didnt get it, can you try rephrasing ')
            } else {
                if (!sampleConversationRunning) {
